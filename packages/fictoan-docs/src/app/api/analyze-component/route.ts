...
const analyzeComponent = async (componentName: string): Promise<ComponentMetadata | null> => {
    ...
    const supportedComponents = ["Accordion", "Badge", "Button", "Breadcrumbs", "Callout", "Card", "Divider", "Drawer", "ListBox", "Modal", "OptionCard", "OptionCardsGroup", "Pagination", "Meter", "ProgressBar", "Table", "Tabs"];
