// Configuration for Checkbox component documentation

// LIB =================================================================================================================
import { createPropsRegistry } from "$/lib/props-registry/createPropsRegistry";

export const checkboxRegistry = createPropsRegistry({
    component : "Checkbox",
    ...
    props : {
        ...
        helpText : {
            ...
            control : "InputField",
            inputProps : {
                helpText : "Additional helper text displayed below the checkbox",
            },
        },
        errorText : {
            label   : "Error text",
